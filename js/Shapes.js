...
(function () {
	...
	//自定义一个形状
	// UML Actor Shape
	function UmlActorShape2() {
		mxShape.call(this);
	};
	mxUtils.extend(UmlActorShape2, mxShape);
	UmlActorShape2.prototype.paintBackground = function (c, x, y, w, h) {

		c.translate(x, y);

		// Head
		c.ellipse(w / 4, 0, w / 2, h / 8);
		c.fillAndStroke();
	...
	// Replaces existing actor shape
	mxCellRenderer.registerShape('umlActor2', UmlActorShape2);
	...
	//自定义形状的连接点
	UmlActorShape2.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0.25, 0.1), false),
