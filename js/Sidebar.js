...
Sidebar.prototype.init = function()
{
	...
	this.addImagePalette('clipart', mxResources.get('clipart'), dir + '/clipart/', '_128x128.png',
		['Earth_globe', 'Empty_Folder', 'Full_Folder', 'Gear', 'Lock', 'Software', 'Virus', 'Email',
		 ...
		 'Worker1', 'Soldier1','bd_logo1', 'Doctor1', 'Tech1', 'Security1', 'Telesales1'], null,
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
	    ...
	    this.createVertexTemplateEntry('shape=callout;whiteSpace=wrap;html=1;perimeter=calloutPerimeter;', 120, 80, '', 'Callout', null, null, 'bubble chat thought speech message'),
	 	...
	 	this.createVertexTemplateEntry('shape=umlActor2;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;html=1;outlineConnect=0;', 30, 60, 'Actor', 'Actor2', false, null, 'user person human stickman'),
